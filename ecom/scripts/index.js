...
autoSlide();
  ...
  function openWithUrl(div) {
    const img = div.querySelector('img').src;
    const price= div.querySelector('img').alt;
    const title = div.querySelector('p').textContent;
  
    localStorage.setItem('productData', JSON.stringify({ img, price, title }));
