...
<header>
    ...
    <a id="logo" href="index.html"><img   src="styles/images/logo.png" alt="logo" style="width: 200px; height: 100px;"></a>
    
    <div class="rightbox">
        <a href="profile.html" id="profile"><svg width="18px" height="18px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
<div class="container">
<?php 
echo"<h2>Welcome saad to ur profile</h2>";
?>
