...
public:
    ...
    void supprimerTerrain(int index) {
        if (index >= 0 && index < terrains.size()) {
            ...
            cout << "Terrain supprim� avec succ�s." << endl;
        } else {
    ...
    Terrain& rechercherTerrain(const string nom) {
        ...
        throw runtime_error("Terrain non trouv�.");
    }
    ...
    void afficherTousLesTerrains() const {
        if (terrains.empty()) {
            ...
            for (const auto& terrain : terrains) {
                cout << "Terrain : " << terrain.getNom() << ", Capacit� : " << terrain.getCapacite() << endl;
            }
        }
    }
    ...
    Terrain& getTerrainAleatoire() {
        if (terrains.empty()) {
            throw runtime_error("Aucun terrain disponible pour s�lectionner un terrain al�atoire.");
        }
...
public:
    ...
    void supprimerJoueur(int id) {
        ...
        if (it != joueurs.end()) {
            joueurs.erase(it);
            cout << "Joueur supprim� avec succ�s." << endl;
        } else {
    ...
    void afficherTicket() const {
     ...
     bool reserver() {
        if (terrain.getCapacite() > 0) {
            ...
            cout << "Ticket r�serv� avec succ�s pour " << phase << ". Prix: " << prix << ".\n";
            return true;
        }
        cout << "D�sol�, il n'y a plus de place pour cette phase.\n";
        return false;
    }
};
...
public:
    void planifierTournoi(GestionJoueurs& gestionJoueurs, GestionTerrain& gestionTerrain) {
        ...
        if (joueurs.size() != 2 && joueurs.size() != 4 && joueurs.size() != 8 && joueurs.size() != 16) {
            cout << "Le tournoi n�cessite 2, 4, 8 ou 16 joueurs pour d�marrer.\n";
            return;
        }


        string phases[] = {"Huiti�mes", "Quarts", "Demi-finales", "Finale"};
        int phaseIndex = 0;
...
int main() {
    ...
    break;
            ...
            case 2: {
                int id;
                cout << "Entrez l'ID du joueur � supprimer : ";
                cin >> id;
            ...
            case 4: {
                ...
                cin >> nomTerrain;
                cout << "Entrez la capacit� du terrain : ";
                cin >> capacite;
            ...
            case 5: {
                int index;
                cout << "Entrez l'indice du terrain � supprimer : ";
                cin >> index;
            ...
            case 7: {
                int id;
                cout << "Entrez l'ID du joueur � rechercher : ";
                cin >> id;
            ...
            case 8: {
                string nomTerrain;
                cout << "Entrez le nom du terrain � rechercher : ";
                cin >> nomTerrain;
                try {
                    Terrain& terrain = gestionTerrain.rechercherTerrain(nomTerrain);
                    cout << "Terrain trouv� : " << terrain.getNom() << ", Capacit� : " << terrain.getCapacite() << endl;
            ...
            case 10: {
                ...
                cin >> nomJoueur;
                cout << "Entrez la phase (Huiti�mes, Quarts, Demi-finales, Finale) : ";
                cin >> phase;
                cout << "Entrez le nom du terrain : ";
                cin >> nomTerrain;
                        ...
                        if (ticket.reserver()) {
                            cout << "Ticket achet� avec succ�s pour " << nomJoueur << " � " << nomTerrain << ". Prix du ticket: " << ticket.getPrix() << " euros.\n";
                        } else {
